...
const PD = '/Users/patrickiben/Biometrics_AI_Program/study_kb_nogui/_video';
const notes = require(PD + '/kb_notes.js');
const SCENE = 'file://' + PD + '/kb_term_scene.html';
const OUT = '/Users/patrickiben/Biometrics_AI_Program/study_kb_nogui/Study_KB_NoGUI_Screencast_narrated.mp4';
const SRT = '/Users/patrickiben/Biometrics_AI_Program/study_kb_nogui/Study_KB_NoGUI_Screencast.srt';
const CHROME = '/Applications/Google Chrome.app/Contents/MacOS/Google Chrome';
const VOICE = 'Daniel', RATE = '150', FPS = 12, GAP = 0.30, TAIL = 1.0, FADE = 0.5, W = 1920, H = 1080;
const WORK = '/tmp/kbcast_pkg'; fs.rmSync(WORK, { recursive: true, force: true }); fs.mkdirSync(WORK, { recursive: true });
