...
*             Categorical: n (%). SAD: parallel ascending-dose cohorts, ONE
*             treatment per participant; columns = TRT01A = assigned dose level
*             (placebo often pooled across cohorts) + Total.
******************************************************************************/
...
%tfltitle(num=14.1.2, type=Table, text=Demographic and Baseline Characteristics,
          ...
          foot=%str(Column = assigned dose level (TRT01A); placebo may be pooled across cohorts. Percentages based on the number of participants in the Safety Population per dose level.));
