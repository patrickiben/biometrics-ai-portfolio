...
*             A dose-related (ascending) trend in TEAE frequency is the key read.
******************************************************************************/
...
run;
/* columns ordered ASCENDING by dose (TRT01AN) + Total; participants unique          */
proc transpose data=_rep out=_wide; by socn ptn level term; id &TRTNVAR; var value; run;

%tfltitle(num=14.3.1.1, type=Table,
   text=%str(Treatment-Emergent Adverse Events by System Organ Class and Preferred Term and Dose Level),
