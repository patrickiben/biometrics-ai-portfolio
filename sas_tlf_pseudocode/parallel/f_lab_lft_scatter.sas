/******************************************************************************
* FIGURE    : f_lab_lft_scatter  (Parallel-group)
...
*             Bilirubin/ULN (y), both log scale, colored by treatment.
...
%tfltitle(num=14.3.4.5, type=Figure,
   ...
   foot=%str(Reference lines: ALT = 3xULN, Total Bilirubin = 2xULN. Both axes log scale. Each point = one participant's peak on-treatment value.));
