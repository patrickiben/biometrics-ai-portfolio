...
**You want to build these yourself.** The whole app is ~150 lines: `shiny/R/logic.R` holds the gate + KPI math (the functions this page also called), and `shiny/app.R` is the UI + reactivity. The [build-it walkthrough](../BUILD_IT.md) takes you through it piece by piece. Change the CSV to your study's tests and it is your tracker.
:::
