...
_Generated 2026-07-05 22:12 EDT · R version 4.6.0 (2026-04-24) · 7/7 gates green · dogfooded on this repo's synthetic deliverables._
...
| **G3 Data conformance & integrity** | the analysis data is CDISC-conformant, intact, and PHI-free | 🟢 green | ADaM conformance PASS (checks/conformance.R); 0 trial-sense 'subject' in programs; 0 PHI/PII hits | ☐ pending |
...
| **G5 Adversarial QC panel** | no skeptical reader can break the deliverable | 🟢 green | multi-lens fix->adversarial-verify panel applied; 51 P0/P1 parity findings resolved; open item honestly disclosed: 6 twin-pairs: fixes applied, independent re-verification pending (disclosed) | ☐ pending |
